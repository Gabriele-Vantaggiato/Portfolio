...
export const INIT_SKILL: ISkill[] = [
  ...
  {id: 'canva', imgSrc: default_skills_path + 'canva.svg', name: 'Canva', competence: "USED"},
  ...
  {id: 'raspberrypi', imgSrc: default_skills_path + 'raspberry-pi.svg', name: 'Raspberry PI', competence: "USED"},
  ...
  {id: 'sourcetree', imgSrc: default_skills_path + 'sourcetree.svg', name: 'Sourcetree', competence: "USED"},
